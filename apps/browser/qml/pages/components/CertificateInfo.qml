...
SilicaFlickable {
    ...
    Rectangle { anchors.fill: parent; z: -1; opacity: 0.92; color: Qt.darker(Qt.tint(Theme.colorScheme === Theme.LightOnDark ? "#1c1c1c" : "#f2f2f2", Qt.rgba(Theme.highlightColor.r, Theme.highlightColor.g, Theme.highlightColor.b, 0.52)), 1.55)
        Image {
            anchors.fill: parent
